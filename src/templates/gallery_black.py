"""
Template B: Gallery Black
Black background, image centered, fine white/gray text.
"""
...
class GalleryBlackTemplate(BaseTemplate):
    name = 'Gallery Black'
    description = 'Black background, fine light text — cinematic, gallery'
    ...
    def render(self, image: Image.Image, exif: ExifSource, params: RenderParams) -> Image.Image:
        ...
        m_bottom = int(max(params.margin_bottom, 160) * canvas_h / 2048)
        ...
        if params.image_shadow:
            ...
            canvas_rgba = draw_shadow(
                canvas_rgba, img_box, params.image_corner_radius,
                alpha=40
            )
        ...
        draw.rectangle(
            ...
            outline=mix_color(bg_color, (255, 255, 255), 0.10),
            width=max(1, canvas_w // 1300),
        )
        ...
        if exif_line and params.font_size > 0:
            ...
            self._draw_fitted_text(
                ...
                max(10, params.font_size - 2), font_color,
